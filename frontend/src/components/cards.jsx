...
function Cards() {
    return (
        <div className="cards">
            <figure>
                <a href="">
                    <img src="A Million Seconds Too Late.png" alt="A Million Seconds Too Late" />
                </a>
            </figure>
            <h1><a href="">A Million Seconds Too Late</a></h1>
            <small>Date read: 2023-08-02. How strongly I recommend it: 10/10</small>
            <strong>ISBN 384738926498</strong>
